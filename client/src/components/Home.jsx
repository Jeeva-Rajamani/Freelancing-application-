            ...
            <footer>
                ...
                <div className="footer-footer">
                    <div className="copyright">
                        Copyright SB Works ©2023 | All Rights Reserved
                    </div>
